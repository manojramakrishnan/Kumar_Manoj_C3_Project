...
class RestaurantServiceTest {
    ...
    public void restaurantSetup(){
        this.restaurant = service.addRestaurant("Amelie's cafe","chennai",LocalTime.parse("10:30:00"),LocalTime.parse("22:00:00"));
        service.addRestaurant("madras cafe","chennai",LocalTime.parse("08:30:00"),LocalTime.parse("21:00:00"));
